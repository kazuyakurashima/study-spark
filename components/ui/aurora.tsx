...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    script.src = "https://unpkg.com/ogl@1.0.0/dist/ogl.umd.js"
    script.async = true
  ...
  const initializeAurora = () => {
    if (!window.OGL || !ctnDom.current) return
  ...
  return (
    <>
      <Script
        src="https://unpkg.com/ogl@1.0.0/dist/ogl.umd.js"
